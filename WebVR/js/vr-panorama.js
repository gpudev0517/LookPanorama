...
window.VRPanorama = (function () {
  ...
  var panoFS = [
    ...
    "uniform int stereoType; //0: left, 1:right, 2:mono",
    "varying vec2 vTexCoord;",
    ...
    "    newTexCoord.y = newTexCoord.y / 2.0 + 0.5;",
  ...
  Panorama.prototype.setStereo = function (stereo) {
  ...
  Panorama.prototype.setVideo = function (elementId) {
    var gl = this.gl;
    var self = this;
  ...
  Panorama.prototype.setRerendering = function(isRerendering){
    this.isRerendering = isRerendering;
  };

  Panorama.prototype.render = function (projectionMat, modelViewMat, stereoType) {
    var gl = this.gl;
    ...
    var curStereoType = this.isStereo ? stereoType : 2;
    gl.uniform1i(program.uniform.stereoType, curStereoType);
    ...
    if (this.videoElement && !this.videoElement.paused && this.isRerendering) {
