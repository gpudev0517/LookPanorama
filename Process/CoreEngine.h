...
//	QObject *applicationSetting() const;
	QObject* singleCalib() const
	{
		return m_singleCalib;
	}
	...
	{
		m_isExit = isExit; emit exitChanged( true );
	}
	bool start()
	{
		return m_isStarted;
	}
	void setStart( bool isStarted )
	{
		m_isStarted = isStarted; emit started( true );
	}
	QString loadingMessage()
	{
		return m_loadingMessage;
	}
	void setLoadingMessage( QString loadingMessage )
	{
		m_loadingMessage = loadingMessage; emit loadingMessageReceived( m_loadingMessage );
	}
	bool playFinish()
	{
		return m_isPlayFinished;
	}
	void setPlayFinish( bool isPlayFinished )
	{
		m_isPlayFinished = isPlayFinished; emit playFinished();
	};
	QString errorMsg()
	{
		return m_errorMsg;
	...
	{
		m_errorMsg = errorMsg; emit error();
	}
	bool calibrated()
	{
		return m_calibResult;
	}
	QString notifyMsg()
	{
		return m_notifyMsg;
	}
	bool templatePacFileLoaded()
	{
		return m_isTemplatePacFileLoad;
	}
	void setTemplatePacFileLoaded( bool isLoaded )
	{
		m_isTemplatePacFileLoad = isLoaded;
	}
	QString getPlayBackFilePath()
	{
		return m_strTrackFilePath;
	}
	QString getCaptureImageFilePath()
	{
		return m_strImageFilePath;
	}
	int weightMapEditCameraIndex()
	{
		return m_weightMapEditCameraIndex;
	}
	void setWeightMapEditCameraIndex( int cameraIndex )
	{
		m_weightMapEditCameraIndex = cameraIndex;
	}
	bool weightMapEditUndoStatus()
	{
		return m_weightMapEditUndoStatus;
	}
	void setWeightMapEditUndoStatus( bool undoStatus )
	{
		m_weightMapEditUndoStatus = undoStatus;
	}
	bool weightMapEditRedoStatus()
	{
		return m_weightMapEditRedoStatus;
	}
	void setWeightMapEditRedoStatus( bool redoStatus )
	{
		m_weightMapEditRedoStatus = redoStatus;
	}
	bool weightMapResetStatus()
	{
		return m_weightMapResetStatus;
	}
	void setWeightMapResetStatus( bool resetStatus )
	{
		m_weightMapResetStatus = resetStatus;
	}
	QString singleCalibMessage() const
	{
		return m_singleCalibMessage;
	}
	int singleCalibStatus() const
	{
		return m_singleCalibStatus;
	}
	float strengthRatio() const
	{
		return m_strengthRatio;
	}
	QString strengthDrawColor() const
	{
		return m_strengthDrawColor;
	}
	QVariantList grayLutData() const
	{
		return sharedImageBuffer->getGlobalAnimSettings()->getLutData()[0];
	}
	QVariantList redLutData() const
	{
		return sharedImageBuffer->getGlobalAnimSettings()->getLutData()[1];
	}
	QVariantList greenLutData() const
	{
		return sharedImageBuffer->getGlobalAnimSettings()->getLutData()[2];
	}
	QVariantList blueLutData() const
	{
		return sharedImageBuffer->getGlobalAnimSettings()->getLutData()[3];
	}

	QString streamingPath()
	{
...
public:
	...
	GlobalAnimSettings& getGlobalAnimSetting()
	{
		return m_d360Data.getGlobalAnimSettings();
	}

	void sendWeightMapEditCameraIndexChanged( int cameraIndex )
	{
		m_weightMapEditCameraIndex = cameraIndex; emit weightMapEditCameraIndexChanged( cameraIndex );
	}
	void sendWeightMapEditUndoStatusChanged( bool isEnable )
	{
		m_weightMapEditUndoStatus = isEnable; emit weightMapEditUndoStatusChanged( isEnable );
	}
	void sendWeightMapEditRedoStatusChanged( bool isEnable )
	{
		m_weightMapEditRedoStatus = isEnable; emit weightMapEditRedoStatusChanged( isEnable );
	}
	void sendWeightMapResetStatusChanged( bool isReset )
	{
		m_weightMapResetStatus = isReset; emit weightMapResetStatusChanged( isReset );
	}
	void sendSingleCalibMessageChanged( QString messageText )
	{
		m_singleCalibMessage = messageText; emit singleCalibMessageChanged( messageText );
	}
	void sendSingleCalibStatusChanged( int singleCalibStatus )
	{
		m_singleCalibStatus = singleCalibStatus; emit singleCalibStatusChanged( singleCalibStatus );
	}
	void sendStrengthRatioChanged( float strengthRatio )
	{
		m_strengthRatio = strengthRatio; emit strengthRatioChanged( strengthRatio );
	}
	void sendStrengthDrawColorChanged( QString color )
	{
		m_strengthDrawColor = color; emit strengthDrawColorChanged( color );
	}
...
private:
	...
	{
		return m_isDisconnectComplete;
	}
	void setDisconnectComplete( bool disconnectComplete )
	{
		m_isDisconnectComplete = disconnectComplete; m_connectedCameras = false; emit disconnectCompleted( m_isDisconnectComplete );
	}
	...
	//Recent Title, Path
	QString getRecentTitle( int index )
	{
		return m_recentList[index].title;
	}
	QString getRecentPath( int index );
	QString getRecentFullPath( int index )
	{
		return m_recentList[index].fullPath;
	}
	int getRecentType( int index )
	{
		return m_recentList[index].type;
	}
	...
	void clearTemplateOrderList()
	{
		m_templateOrderList.clear();
	}
	int getRigTemplateCameraCount()
	{
		return m_d360Data.getRigTemplateGlobalAnimSettings().m_cameraCount;
	}
	...
	void setCameraCnt( int numCameraCnt )
	{
		m_cameraCnt = numCameraCnt;
	}
	int getAudioCnt()
	{
		return m_audioCnt;
	...
	void setPlaybackIndex( QModelIndex index);
	...
	QString getTemplateIniFileName()
	{
		return m_templateIniFile;
	}
	...
	int getImageCount()
	{
		return m_imagePathList.size();
	}
	void initTemplateImageObject()
	{
	...
	void initTemplateVideoObject()
	{
		if( m_videoPathList.size() > 0 )
		{
			m_videoPathList.clear();
		}
	}
	void initTemplateCameraObject()
	{
		if( m_cameraNameList.size() > 0 )
		{
			m_cameraNameList.clear(); m_audioNameList.clear();
		}
	}
	int  getTemplateImageCount()
	{
		return m_imagePathList.size();
	}
	int  getTemplateVideoCount()
	{
		return m_videoPathList.size();
	}
	int  getTemplateCameraCount()
	{
		return m_cameraNameList.size();
	}
	...
	{
		m_d360Data.setStartFrame( fStartFrame );
	}
	...
	{
		m_d360Data.setEndFrame( fEndFrame );
	}
	...
	int getCameraCount()
	{
		return m_d360Data.getCameraCount();
	}
	void setCameraCount( int cameraCount )
	{
		m_d360Data.setCameraCount( cameraCount );
	}

	//fps
	float getFps()
	{
		return m_d360Data.getFps();
	}
	void setFps( float fps )
	{
		m_d360Data.setFps( fps );
	}

	//source fps
	float getSourceFps()
	{
		return m_d360Data.getSourceFps();
	}
	void setSourceFps( float sourcefps )
	{
		m_d360Data.setSourceFps( sourcefps );
	}

	//input resolution
	int getXres()
	{
		return m_d360Data.getXres();
	}
	void setXres( int xres )
	{
		m_d360Data.setXres( xres );
	}
	int getYres()
	{
		return m_d360Data.getYres();
	}
	void setYres( int yres )
	{
		m_d360Data.setYres( yres );
	}
	...
	{
		m_d360Data.setCameraCalib( cameraCalib );
	}

	//sample Fmt
	int getSampleFmt()
	{
		return m_d360Data.getSampleFmt();
	}
	void setSampleFmt( int sampleFmt )
	{
		m_d360Data.setSampleFmt( sampleFmt );
	}

	//lag
	int getLag()
	{
		return m_d360Data.getLag();
	}
	void setLag( int lag )
	{
		m_d360Data.setLag( lag );
	}

	//output resolution
	int getPanoXres()
	{
		return m_d360Data.getPanoXres();
	}
	void setPanoXres( int panoXres )
	{
		m_d360Data.setPanoXres( panoXres );
	}
	int getPanoYres()
	{
		return m_d360Data.getPanoYres();
	}
	void setPanoYres( int panoYres )
	{
		m_d360Data.setPanoYres( panoYres );
	}

	//device Count
	int getDeviceCount()
	{
		return m_d360Data.getGlobalAnimSettings().m_cameraCount;
	}
	...
	{
		m_d360Data.setTempCameraSettings();
	}
	...
	//Calibration
	void setCalibFile( QString calibFile )
	{
		m_d360Data.getGlobalAnimSettings().setCameraCalib( calibFile );
	}
	QString getCalibFile()
	{
		return m_d360Data.getGlobalAnimSettings().m_cameraCalibFile;
	}
	int getLensType()
	{
		return m_d360Data.getGlobalAnimSettings().m_lensType;
	}
	void setLensType( int lensType )
	{
		m_d360Data.getGlobalAnimSettings().m_lensType = ( CameraParameters::LensType )lensType;
	}
	int getFov()
	{
		return m_d360Data.getGlobalAnimSettings().m_fov;
	}
	void setFov( int fov )
	{
		m_d360Data.getGlobalAnimSettings().m_fov = fov;
	}
	...
	bool getOculus()
	{
		return m_d360Data.getGlobalAnimSettings().m_oculus && m_oculusDevice != NULL && m_oculusDevice->isConnected();
	}
	...
	int getTempWidth()
	{
		return m_d360Data.getTempGlobalAnimSettings().m_xres;
	}
	void setTempWidth( int width )
	{
		m_d360Data.getTempGlobalAnimSettings().setXres( width );
	}
	int getTempHeight()
	{
		return m_d360Data.getTempGlobalAnimSettings().m_yres;
	}
	void setTempHeight( int height )
	{
		m_d360Data.getTempGlobalAnimSettings().setYres( height );
	}
	int getTempPanoWidth()
	{
		return m_d360Data.getTempGlobalAnimSettings().m_panoXRes;
	}
	void setTempPanoWidth( int width )
	{
		m_d360Data.getTempGlobalAnimSettings().setPanoXres( width );
	}
	int getTempPanoHeight()
	{
		return m_d360Data.getTempGlobalAnimSettings().m_panoYRes;
	}
	void setTempPanoHeight( int height )
	{
		m_d360Data.getTempGlobalAnimSettings().setPanoYres( height );
	}
	float getTempFPS()
	{
		return m_d360Data.getTempGlobalAnimSettings().m_fps;
	}
	void setTempFPS( float fps )
	{
		m_d360Data.getTempGlobalAnimSettings().setFps( fps );
	}
	float getTempSourceFPS()
	{
		return m_d360Data.getTempGlobalAnimSettings().m_sourcefps;
	}
	void setTempSourceFPS( float sourceFps )
	{
		m_d360Data.getTempGlobalAnimSettings().setSourceFps( sourceFps );
	}
	QString getTempCalibFile()
	{
		return m_d360Data.getTempGlobalAnimSettings().m_cameraCalibFile;
	}
	void setTempCalibFile( QString calibFile )
	{
		m_d360Data.getTempGlobalAnimSettings().setCameraCalib( calibFile );
	}
	int getTempStartFrame()
	{
		return m_d360Data.getTempGlobalAnimSettings().m_startFrame;
	}
	void setTempStartFrame( int nFrame )
	{
		m_d360Data.getTempGlobalAnimSettings().setStartFrame( nFrame );
	}
	int getTempEndFrame()
	{
		return m_d360Data.getTempGlobalAnimSettings().m_endFrame;
	}
	void setTempEndFrame( int nFrame )
	{
		m_d360Data.getTempGlobalAnimSettings().setEndFrame( nFrame );
	}
	QString getTempFileExt()
	{
		return m_d360Data.getTempGlobalAnimSettings().m_fileExt;
	}
	void setTempFileExt( QString fileExt )
	{
		m_d360Data.getTempGlobalAnimSettings().setFileExt( fileExt );
	}
	bool getTempOculus()
	{
		return m_d360Data.getTempGlobalAnimSettings().m_oculus;
	}
	void setTempOculus( bool oculus )
	{
		m_d360Data.getTempGlobalAnimSettings().m_oculus = oculus;
	}
	QString getTempOfflineVideoCodec()
	{
		return getVideoCodecStringFromType( m_d360Data.getTempGlobalAnimSettings().m_videoCodec );
	}
	void setTempOfflineVideoCodec( QString codec )
	{
		m_d360Data.getTempGlobalAnimSettings().m_videoCodec = getVideoCodecTypeFromString( codec );
	}
	QString getTempOfflineAudioCodec()
	{
		return getAudioCodecStringFromType( m_d360Data.getTempGlobalAnimSettings().m_audioCodec );
	}
	void setTempOfflineAudioCodec( QString codec )
	{
		m_d360Data.getTempGlobalAnimSettings().m_audioCodec = getAudioCodecTypeFromString( codec );
	}
	QString getTempStreamVideoCodec()
	{
		return getVideoCodecStringFromType( m_d360Data.getTempGlobalAnimSettings().m_videoCodec );
	}
	void setTempStreamVideoCodec( QString codec )
	{
		m_d360Data.getTempGlobalAnimSettings().m_videoCodec = getVideoCodecTypeFromString( codec );
	}
	QString getTempStreamAudioCodec()
	{
		return getAudioCodecStringFromType( m_d360Data.getTempGlobalAnimSettings().m_audioCodec );
	}
	void setTempStreamAudioCodec( QString codec )
	{
		m_d360Data.getTempGlobalAnimSettings().m_audioCodec = getAudioCodecTypeFromString( codec );
	}
	// Auto Calibrating...
	int getTempLensType()
	{
		return m_d360Data.getTempGlobalAnimSettings().m_lensType;
	}
	void setTempLensType( int lensType )
	{
		m_d360Data.getTempGlobalAnimSettings().m_lensType = ( CameraParameters::LensType )lensType;
	}
	int getTempFov()
	{
		return m_d360Data.getTempGlobalAnimSettings().m_fov;
	}
	void setTempFov( int fov )
	{
		m_d360Data.getTempGlobalAnimSettings().m_fov = fov;
	}

	void resetTempGlobalSettings()
	{
		m_d360Data.resetTempGlobalAnimSettings();
	}
	void clearTempGlobalSettings()
	{
		m_d360Data.clearTempGlobalAnimSettings();
	}
	...
	{
		sharedImageBuffer->getStitcher()->restitch( cameraParamChanged );
	}
	...
	int getCaptyreType()
	{
		return m_d360Data.getGlobalAnimSettings().m_captureType;
	}
	...
	int getQuality()
	{
		return m_d360Data.getTempGlobalAnimSettings().m_crf;
	}
	void setQuality( int quality )
	{
		m_d360Data.getTempGlobalAnimSettings().m_crf = quality;
	}

	// Use NVidia
	void enableNvidia( bool isGpu )
	{
		m_d360Data.getGlobalAnimSettings().m_isGPU = isGpu;
	}
	bool isNvidia()
	{
		return m_d360Data.getGlobalAnimSettings().m_isGPU;
	}
	...
	int getBannerCount()
	{
		return m_d360Data.getGlobalAnimSettings().m_banners.size();
	}

	void resetCamSettings();
	bool isStereo()
	{
		return m_d360Data.getGlobalAnimSettings().isStereo();
	}
	...
	// close project
	void setCloseProject( bool isClose )
	{
		m_isClose = isClose;
	};
	bool isCloseProject()
	...
	{
		return (int)sharedImageBuffer->getStitcher()->getColorTemperature();
	}
	...
	bool isNodalConfiguration()
	{
		return m_d360Data.getGlobalAnimSettings().m_nodalVideoIndex >= 0;
	}

	// Camera Parameters
	float  getYaw( int deviceNum )
	{
		return m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_yaw;
	}
	void setYaw( float yaw, int deviceNum )
	{
		m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_yaw = yaw;
	}
	float getPitch( int deviceNum )
	{
		return m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_pitch;
	}
	void setPitch( float pitch, int deviceNum )
	{
		m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_pitch = pitch;
	}
	float getRoll( int deviceNum )
	{
		return m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_roll;
	}
	void setRoll( float roll, int deviceNum )
	{
		m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_roll = roll;
	}
	int getLensType( int deviceNum )
	{
		return m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_lensType;
	}
	float getFov( int deviceNum )
	{
		return m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_fov;
	}
	void setFov( float fov, int deviceNum )
	{
		m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_fov = fov;
	}
	float getFovy( int deviceNum )
	{
		return m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_fovy;
	}
	void setFovy( float fovy, int deviceNum )
	{
		m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_fovy = fovy;
	}
	float getK1( int deviceNum )
	{
		return m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_k1;
	}
	void setK1( float k1, int deviceNum )
	{
		m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_k1 = k1;
	}
	float getK2( int deviceNum )
	{
		return m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_k2;
	}
	void setK2( float k2, int deviceNum )
	{
		m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_k2 = k2;
	}
	float getK3( int deviceNum )
	{
		return m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_k3;
	}
	void setK3( float k3, int deviceNum )
	{
		m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_k3 = k3;
	}
	float getOffsetX( int deviceNum )
	{
		return m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_offset_x;
	}
	void setOffsetX( float offset_x, int deviceNum )
	{
		m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_offset_x = offset_x;
	}
	float getOffsetY( int deviceNum )
	{
		return m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_offset_y;
	}
	void setOffsetY( float offset_y, int deviceNum )
	{
		m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_offset_y = offset_y;
	}
	float getExpOffset( int deviceNum )
	{
		return m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_expOffset;
	}
	void setExpOffset( float expOffset, int deviceNum )
	{
		m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).m_cameraParams.m_expOffset = expOffset;
	}
	int getWidth( int deviceNum )
	{
		return m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).xres;
	}
	int getHeight( int deviceNum )
	{
		return m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).yres;
	}
	void setWidth( int width, int deviceNum )
	{
		m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).xres = width;
	}
	void setHeight( int height, int deviceNum )
	{
		m_d360Data.getGlobalAnimSettings().getCameraInput( deviceNum ).yres = height;
	}

	QString getTempSplitMins()
	{
		return QString::number( m_d360Data.getTempGlobalAnimSettings().m_splitMins );
	}
	void setTempSplitMins( QString splitMins )
	{
		qDebug() << splitMins; m_d360Data.getTempGlobalAnimSettings().m_splitMins = splitMins.toFloat();
	}
